    ...
    <Layout>
      <HeroParallax projects={PROJECTS}>
        <div className="max-w-7xl relative mx-auto py-20 xl:py-40 px-4 w-full left-0 top-0">
          <h1 className={`text-4xl md:text-7xl font-bold font-anta ${isDark ? "text-white" : "text-gray-900"}`}>
            Projects
          </h1>
          <p className={`max-w-2xl text-xs md:text-xl mt-8 ${isDark ? "text-neutral-200" : "text-gray-700"}`}>
